<header>
    <nav class="navbar navbar-expand-lg navbar-light py-2 bg-white shadow-sm">
        <div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<div class="header-right ms-auto">
					<ul class="navbar-nav align-items-lg-center n-log">
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://psikologanda.com/" target="_blank">Beranda</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://psikologanda.com/tentang-kami/" target="_blank">Tentang Kami</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://psikologanda.com/layanan/" target="_blank">Layanan</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://psikologanda.com/psikolog/" target="_blank">Psikolog</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://psikologanda.com/#" target="_blank">Artikel</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://belajar.psikologanda.com/" target="_blank">Belajar</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link {{ strpos(Request::url(), '/karir') ? 'active' : '' }}" href="{{ route('site.karir.index') }}">Karir</a> </li>
						<li style="margin-left: 5px" class="nav-item"> <a class="nav-link" href="https://karir.psikologanda.com/login" target="_blank">BK / HRD</a> </li>
