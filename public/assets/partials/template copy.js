    ...
    bar += '<header>';
        bar += '<nav class="navbar navbar-expand-lg navbar-light py-2 fixed-top bg-white shadow-sm">';
            bar += '<div class="container">';
                bar += '<a class="navbar-brand mb-0" href="https://belajar.psikologanda.com"><img src="https://belajar.psikologanda.com/assets/images/logo/2023-07-03-10-38-48.png" alt="Logo PsikologAnda">'; bar += '</a>';
                ...
                bar += '<div class="collapse navbar-collapse" id="navbarResponsive">';
                    bar += '<div class="header-right ms-auto">';
                       bar += '<ul class="navbar-nav align-items-lg-center n-log">';
                            bar += '<li class="nav-item">';  bar += '<a class="nav-link" href="https://belajar.psikologanda.com">Beranda'; bar += '</a>';  bar += '</li>';
                            bar += '<li class="nav-item dropdown">';
                                ...
                                bar += '<div class="dropdown-menu dropdown-menu-right">';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/e-learning" class="dropdown-item" type="button">E-Learning'; bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/online-course" class="dropdown-item" type="button">Online Course';  bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/workshop" class="dropdown-item" type="button">Workshop'; bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/sertifikasi" class="dropdown-item" type="button">Sertifikasi';  bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/seleksi-rekruitmen" class="dropdown-item" type="button">Seleksi & Rekrutmen';  bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/pelatihan-pendampingan" class="dropdown-item" type="button">Pelatihan & Pendampingan';  bar += '</a>';
                                    bar += '<a href="https://belajar.psikologanda.com/program/kategori/konseling-psikoterapi" class="dropdown-item" type="button">Konseling & Psikoterapi';  bar += '</a>';
                                bar += '</div>';
                            bar += '</li>';
                            bar += '<li class="nav-item">';  bar += '<a class="nav-link" href="https://karir.psikologanda.com/login" target="_blank">HRD</a>'; bar += '</li>';
                            bar += '<li class="nav-item">';  bar += '<a class="nav-link" href="https://belajar.psikologanda.com/psikolog">Psikolog</a>'; bar += '</li>';
                            bar += '<li class="nav-item">';  bar += '<a class="nav-link" href="https://belajar.psikologanda.com/karir">Karir</a>'; bar += '</li>';
                            ...
                            bar += '<li class="nav-item">';  bar += '<a class="btn btn-primary ms-0 ms-lg-2 px-3 mb-2 mb-lg-0 d-grid" href="https://belajar.psikologanda.com/login">Masuk</a>'; bar += '</li>';
                            bar += '<li class="nav-item">';  bar += '<a class="btn btn-secondary ms-0 ms-lg-2 px-3 mb-2 mb-lg-0 d-grid" href="https://belajar.psikologanda.com/register">Daftar</a>'; bar += '</li>';
                        bar += '</ul>';
                    bar += '</div>';
                bar += '</div>';
            bar += '</div>';
